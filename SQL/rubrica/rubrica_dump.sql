...
INSERT INTO utente (id,name, surname, age, telephone, smart) VALUES
				   (1, 'Pippo', 'Pluto', 84, 123456798, 1),
                   (2, 'Giuseppe', 'Bianchi', 51, 84963, 3),
                   (3, 'Marco', 'Rossi', 15, 4597863,10),
                   (4, 'Salvatore', 'Giallo', 42, 789452, 17),
                   (5, 'Salvatore', 'Giallo', 42, 4215987, 19),
                   (6, 'Roberto', 'Tizio', 33, 654123, 8),
                   (7, 'Gino', 'Palla', 26, 741258, 6),
                   (8, 'Filiberto', 'Pino', 41, 64289, 15),
                   (9, 'Francesco', 'Nero', 67, 741258, 15),
                   (10, 'Antonia', 'Coviello', 26, 14597845, 2);