...
/**
 * This is the extension manager of the Hospital extension.
 */
public class HospitalManager extends GeneratedHospitalManager
{
	...
	{
		return (HospitalManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitalConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitalManager() // NOPMD 
	{
		LOG.debug("constructor of HospitalManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitalManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitalManager called, current tenant: {}", getTenant().getTenantID());
	}
