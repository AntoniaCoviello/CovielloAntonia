...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitalService.class);
	...
	{
		return DefaultHospitalService.class.getResourceAsStream("/hospital/sap-hybris-platform.png");
	}
